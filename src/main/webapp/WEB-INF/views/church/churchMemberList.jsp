...
<link href="/resources/css/flat/green.css" rel="stylesheet">
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="/resources/images/img.jpg" alt="">John
									Doe
							</a>
							...
							<li role="presentation" class="nav-item dropdown open"><a
								...
								<ul class="dropdown-menu list-unstyled msg_list" role="menu"
									...
									<li class="nav-item"><a class="dropdown-item"> <span
											class="image"><img src="/resources/images/img.jpg"
...
<script src="/resources/js/nprogress.js" type="text/javascript"></script>
...
function reload(param){
	...
	ajaxCall('<%=request.getContextPath()%>/church/churchMemberListTpl.do',param, innerHTML,'datalist');
}
